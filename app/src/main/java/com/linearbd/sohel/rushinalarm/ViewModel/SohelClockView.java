...
public class SohelClockView extends ClockView implements Runnable {
    ...
    private void init(Context context, AttributeSet attrs){
        ...
        setDigitalClockTextColor(ContextCompat.getColor(context,R.color.text_light));
        //setCircleColor(context.getColor(R.color.theme_blue_text));
        setCircleColor(ContextCompat.getColor(context,R.color.theme_blue_text));
        //setDotColor(context.getColor(R.color.sample_red));
        setDotColor(ContextCompat.getColor(context,R.color.sample_red));
        //setHourHandColor(context.getColor(R.color.material_animations_primary_dark));
        setHourHandColor(ContextCompat.getColor(context,R.color.material_animations_primary_dark));
        //setMinuteHandColor(context.getColor(R.color.material_animations_primary));
        setMinuteHandColor(ContextCompat.getColor(context,R.color.material_animations_primary));
        //setSecondHandColor(context.getColor(R.color.sample_yellow));
        setSecondHandColor(ContextCompat.getColor(context,R.color.sample_yellow));
